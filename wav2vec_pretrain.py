...
class CustomDataset(Dataset):
    ...
    def load_ds(self, all_files):
        li = []
        filename = '/home/evgeniy/data_example.csv'
...
class DataCollatorForWav2Vec2Pretraining:
    ...
    def __call__(self, features: List[Dict[str, Union[List[int], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
        ...
        #  Проверил. При данных изменениях mask_time_prob = 0.5 и mask_time_length = 2 обучение идет нормально, loss и  contrastive_loss падают как на трейне так и на валидации
